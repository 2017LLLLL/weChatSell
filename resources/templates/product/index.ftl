            ...
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <form role="form" method="post" action="/seller/product/save" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>图片</label>
                            <input id="productIcon" style="width: 200px;height: 200px;" name="productShow" type="text" hidden="hidden" value="${(productInfo.productIcon)!''}"/>

                            <div class="file-loading">
                                <input id="input-id" type="file" name="productIcon">
...
<script>
    ...
    $(function () {
        ...
        if ('${(productInfo.productIcon)!""}' != '') {
            initialPreview = "<img height='100px' width='100px' class='kv-preview-data file-preview-image' src='${(productInfo.productIcon)!""}'>"
        }

        $("#input-id").fileinput({
           /* uploadUrl: '/sell/image/upload',*/
            uploadUrl:'E:/Download',
            language: 'zh',
